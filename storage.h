...
storage_extended_t* storage_malloc_zzekmr(tensor_t const *tensor);
...
void storage_convert_from_coordinate_to_zzekmr_inplace(tensor_t *destination, tensor_t *source);
